...
public:
	...
	//c(x,y)
	double  Cx(double x, double y,double t);
	...
	double Gauss_qual_trial_test_2D(int alpha, int belta, int r, int s,int p,int q,bool T);

	//计算fx_test高斯积分
	double Gauss_qual_fx_test_2D(int belta, int r, int s, int p, int q,bool T);
